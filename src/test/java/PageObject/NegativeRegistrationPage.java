...
public class NegativeRegistrationPage {
	...
	WebDriver driver;
	public NegativeRegistrationPage(WebDriver rdriver)
	{
		driver = rdriver;
	...
	public void Title() throws IOException 
	{
		...
		a.selectByVisibleText("Ms");
		File n =((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		Files.copy(n, new File("C:\\Users\\avina\\OneDrive\\Desktop\\Personal Project\\Car Insurance Automation\\NG-Title.jpg"));	
	}
	
	public void FirstName() 
	{
		txtname.sendKeys("Avinash2@3;['.,");
	}
	
	public void Surname() 
	{
		txtsurname.sendKeys("Bunde/;SD890-=:[");
	}
	
	public void Phone() 
	{
		txtphone.sendKeys("77568799");
	}
	...
	{
		txtstret.sendKeys("T.corner @87[#'SantFransisko");
	}
	
	public void City() throws IOException 
	{
		txtcity.sendKeys("pariser453@#[98");
		File o =((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		Files.copy(o, new File("C:\\Users\\avina\\OneDrive\\Desktop\\Personal Project\\Car Insurance Automation\\NG-City.jpg"));
		
	}
	
	public void Country() throws IOException 
	{
		txtcountry.sendKeys("japan]8*&^;'");
		File p =((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		Files.copy(p, new File("C:\\Users\\avina\\OneDrive\\Desktop\\Personal Project\\Car Insurance Automation\\NG-Country.jpg"));
		
	}
	
	public void Postcode() 
	{
		txtpostcode.sendKeys("123sgs$#45");
	}
	...
	{
		txtconfirmpassword.sendKeys("sgha#jsj12");
	}
	...
	public void ScrenShot() throws IOException 
	{
		...
		Files.copy(m, new File("C:\\Users\\avina\\OneDrive\\Desktop\\Personal Project\\Car Insurance Automation\\NG-Form.jpg"));
